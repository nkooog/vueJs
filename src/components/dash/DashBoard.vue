        ...
        <div class="row">
          ...
          <div class="col-lg-4">
            <div class="card"><div class="card-body">
              ...
              </div><!-- Bordered Tabs Justified --><!-- End Bordered Tabs Justified --></div></div>
          </div><!-- End Reports -->
          ...
          <div class="col-lg-4">
            <div class="card">
              ...
              <div class="filter">
                <a class="icon" href="#" data-bs-toggle="dropdown"><i class="bi bi-three-dots"></i></a>
                <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                  <li><a class="dropdown-item" href="#">업무실적-채널별</a></li>
                  <li><a class="dropdown-item" href="#">업무실적-상담유형별</a></li>
                  <li><a class="dropdown-item" href="#">업무실적-채널별2</a></li>
                  <li><a class="dropdown-item" href="#">업무실적-상담유형별2</a></li>
                </ul>
              </div>

              <div class="card-body">
                <h5 class="card-title">상담유형별 현황 <span>/Today</span></h5>
                <!-- Line Chart -->
          ...
          <div class="col-lg-4">
            <div class="card">
              ...
              <div class="card-body">
                <h5 class="card-title">뉴스레터 <span>/Today</span></h5>
                <!-- Line Chart -->
                <div id="reportsChart"></div>
              </div>
            </div>
...
<script>
  export default {
    ...
    setup() {},         // 컴포지션 API
    created() {},       // 컴포넌트가 실행되면 실행
    mounted() {},       // tempalte에 정의 된 html 코드가 랜더링 된 후 실행
